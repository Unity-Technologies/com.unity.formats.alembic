...
class IntrusiveArray
{
 public:
    ...
    IntrusiveArray& operator=(const IntrusiveArray& v)
    {
...
class IntrusiveIndexedArray
{
 public:
    ...
    IntrusiveIndexedArray(const I* i, const T* d, size_t s)
        : m_index(const_cast<I*>(i)), m_data(const_cast<T*>(d)), m_size(s)
    {
    }
    IntrusiveIndexedArray(const IntrusiveIndexedArray& v)
        : m_index(const_cast<I*>(v.m_index)), m_data(const_cast<T*>(v.m_data)), m_size(v.m_size)
    {
    }
    template<class IContainer, class VContainer>
    IntrusiveIndexedArray(const IContainer& i, const VContainer& v)
        : m_index(const_cast<I*>(i.data())), m_data(const_cast<T*>(v.data())), m_size(i.size())
    {
    }
