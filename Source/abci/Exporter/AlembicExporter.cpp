...
abciAPI aeProperty* aeNewProperty(aeSchema* obj, const char* name, aePropertyType type)
{
    ...
    {
        // scalar properties
    case aePropertyType::Bool:
        return obj->newProperty<abcBoolProperty>(name);
        break;
    case aePropertyType::Int:
        return obj->newProperty<abcIntProperty>(name);
        break;
    case aePropertyType::UInt:
        return obj->newProperty<abcUIntProperty>(name);
        break;
    case aePropertyType::Float:
        return obj->newProperty<abcFloatProperty>(name);
        break;
    case aePropertyType::Float2:
        return obj->newProperty<abcFloat2Property>(name);
        break;
    case aePropertyType::Float3:
        return obj->newProperty<abcFloat3Property>(name);
        break;
    case aePropertyType::Float4:
        return obj->newProperty<abcFloat4Property>(name);
        break;
    case aePropertyType::Float4x4:
        return obj->newProperty<abcFloat4x4Property>(name);
        break;

        // array properties
    case aePropertyType::BoolArray:
        return obj->newProperty<abcBoolArrayProperty>(name);
        break;
    case aePropertyType::IntArray:
        return obj->newProperty<abcIntArrayProperty>(name);
        break;
    case aePropertyType::UIntArray:
        return obj->newProperty<abcUIntArrayProperty>(name);
        break;
    case aePropertyType::FloatArray:
        return obj->newProperty<abcFloatArrayProperty>(name);
        break;
    case aePropertyType::Float2Array:
        return obj->newProperty<abcFloat2ArrayProperty>(name);
        break;
    case aePropertyType::Float3Array:
        return obj->newProperty<abcFloat3ArrayProperty>(name);
        break;
    case aePropertyType::Float4Array:
        return obj->newProperty<abcFloat4ArrayProperty>(name);
        break;
    case aePropertyType::Float4x4Array:
        return obj->newProperty<abcFloat4x4ArrayProperty>(name);
        break;
    default:
        break;
    }
...
abciAPI int aeGenerateRemapIndices(int* remap, abcV3* points, aeWeights4* weights, int vertex_count)
{
    ...
    if (weights)
    {
        auto compare_op = [&](int vi, int ni)
        { return weights[vi] == weights[ni]; };
        auto weld_op = [&](int vi, int ni)
        { weights[ni] = weights[vi]; };
